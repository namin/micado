...
namespace BioStream.Micado.Utils.PriorityQueue
{
    ...
    public class BinaryPriorityQueue : IPriorityQueue, ICollection, ICloneable, IList
    {
        ...
        /// <summary>
        /// Constructs a new priority queue with an explicit comparer.
        /// </summary>
        /// <param name="c">If c.Compare(x,y)&lt;0 then x is popped before y</param>
